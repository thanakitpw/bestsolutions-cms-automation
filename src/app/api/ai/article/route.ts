...
const WRITER_SYSTEM_PROMPT = `คุณคือนักเขียนบทความ SEO ภาษาไทย ผู้เชี่ยวชาญด้าน Digital Marketing สำหรับตลาดไทย
...
const SITE_INVENTORY = `หน้าหลักของเว็บ bestsolutionscorp.com (ใช้สำหรับ Internal Links):
- บริการ AI Automation: https://bestsolutionscorp.com/services/ai-automation
- บริการ SEO: https://bestsolutionscorp.com/services/seo
- บริการยิงแอด Facebook & Google: https://bestsolutionscorp.com/services/ads
- บริการทำเว็บไซต์: https://bestsolutionscorp.com/services/web-development
- บริการดูแลโซเชียลมีเดีย: https://bestsolutionscorp.com/services/social-media
- บริการผลิต Content: https://bestsolutionscorp.com/services/content
- บล็อก Digital Marketing: https://bestsolutionscorp.com/blog`
